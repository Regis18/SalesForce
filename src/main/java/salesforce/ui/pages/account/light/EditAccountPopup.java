...
public class EditAccountPopup extends EditAccountAbstract {
    ...
    @FindBy(xpath = "//*[label//*[contains(text(),'Parent Account')]]//*[@role='combobox']")
    ...
    @FindBy(xpath = "//*[label//*[contains(text(),'Ticker')]]//*[@class=' input']")
    ...
    @FindBy(xpath = "//*[label//*[contains(text(),'Billing City')]]//*[@type='text']")
    private WebElement billingCityAccount;

    @FindBy(xpath = "//*[label//*[contains(text(),'Billing Country')]]//*[@type='text']")
    private WebElement billingCountryAccount;

    @FindBy(xpath = "//*[label//*[contains(text(),'Billing Zip/Postal Code')]]//*[@type='text']")
    private WebElement billingZipAccount;

    @FindBy(xpath = "//*[label//*[contains(text(),'Billing State/Province')]]//*[@type='text']")
    ...
    @FindBy(xpath = "//*[label//*[contains(text(),'Shipping City')]]//*[@type='text']")
    private WebElement shippingCityAccount;

    @FindBy(xpath = "//*[label//*[contains(text(),'Shipping Country')]]//*[@type='text']")
    private WebElement shippingCountryAccount;

    @FindBy(xpath = "//*[label//*[contains(text(),'Shipping Zip/Postal Code')]]//*[@type='text']")
    private WebElement shippingZipAccount;

    @FindBy(xpath = "//*[label//*[contains(text(),'Shipping State/Province')]]//*[@type='text']")
    ...
    public void setShippingState(final String shippingState) {
        shippingStateAccount.clear();
        shippingStateAccount.sendKeys(shippingState);
    }
